...
router.delete('/admin/leads/:inquiryId', leadAssignmentController.deleteAdminLead);
...
router.delete('/admin/replacements/:id', leadAssignmentController.deleteReplacementRequest);
